...
#' @param extreme_prob [numeric][base::numeric] The probability for identifying extreme trends using quantiles. Default is `0.01`, so the computed extremes will be based on the [quantile][base::quantile()] at `0.01` and `0.99`.
