...
get_dataEx_save = function (var, df_data, period,
    ...
    if (!is.null(functYT_ext) | !is.null(functYT_sum)) {
        ...
        if (!is.null(functYT_sum)) {
            ...
            functY_args[functY_args == '*threshold*'] = names(functY_args)[functY_args == '*threshold*']
